...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/smartcart0111", "_blank");
    }
    if (x == 2) {
        window.open("https://youtube.com/@BenWildfire84", "_blank");
    }
    if (x == 4) {
        window.open("https://tiktok.com/@benwildfire84", "_blank");
    }
}